            ...
            {users.hits &&
              users.hits.map((item) => (
                <figure className="attendee fir-image-figure" key={item.id}>
                  ...
                  <figcaption>
                    <div className="fig-author-figure-title">{item.name}</div>
                    <div className="fig-author-figure-title">Engineer at {item.company.name}</div>
                    <div className="fig-author-figure-title">Signed up: Jan. 5th, 2021</div>
                  </figcaption>
                </figure>
              ))}
          </div>
